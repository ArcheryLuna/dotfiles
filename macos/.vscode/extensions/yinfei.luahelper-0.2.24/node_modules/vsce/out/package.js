...
function versionBump(options) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        if (!options.version) {
            return;
        }
        if (!((_a = options.updatePackageJson) !== null && _a !== void 0 ? _a : true)) {
            return;
        }
        ...
        if (!((_c = options.gitTagVersion) !== null && _c !== void 0 ? _c : true)) {
...
class ManifestProcessor extends BaseProcessor {
    constructor(manifest, options = {}) {
        ...
        this.vsix = Object.assign(Object.assign({}, this.vsix), { id: manifest.name, displayName: manifest.displayName || manifest.name, version: options.version && !((_a = options.updatePackageJson) !== null && _a !== void 0 ? _a : true) ? options.version : manifest.version, publisher: manifest.publisher, target, engine: manifest.engines['vscode'], description: manifest.description || '', categories: (manifest.categories || []).join(','), flags: flags.join(' '), links: {
                repository,
    ...
    onFile(file) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.options.version && !((_a = this.options.updatePackageJson) !== null && _a !== void 0 ? _a : true)) {
                const contents = yield read(file);
                const packageJson = JSON.parse(contents);
                packageJson.version = this.options.version;
                file = Object.assign(Object.assign({}, file), { contents: JSON.stringify(packageJson, undefined, 2) });
            }
    ...
    onEnd() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = this.manifest.activationEvents) === null || _a === void 0 ? void 0 : _a.some(e => e === '*')) {
...
function collectAllFiles(cwd, dependencies, dependencyEntryPoints) {
    return npm_1.getDependencies(cwd, dependencies, dependencyEntryPoints).then(deps => {
...
function getDefaultPackageName(manifest, options) {
    ...
    if (options.version && !((_a = options.updatePackageJson) !== null && _a !== void 0 ? _a : true)) {
...
function listFiles(options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield collectFiles(cwd, getDependenciesOption(options), options.packagedDependencies, options.ignoreFile);
    });
}
...
function ls(options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const files = yield listFiles(Object.assign(Object.assign({}, options), { prepublish: true }));
