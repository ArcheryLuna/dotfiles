...
var gui_1 = require("./client/gui");
var dx_1 = require("./client/dx");
var engine_1 = require("./client/engine");
var vehicle_1 = require("./client/vehicle");
var ped_1 = require("./client/ped");
exports.ClientDefinitions = new Array();
for (var i in gui_1.GuiFunctionDefinitions)
    exports.ClientDefinitions.push(gui_1.GuiFunctionDefinitions[i]);
for (var i in dx_1.DxFunctionDefinitions)
    exports.ClientDefinitions.push(dx_1.DxFunctionDefinitions[i]);
for (var i in engine_1.EngineFunctionDefinitions)
    exports.ClientDefinitions.push(engine_1.EngineFunctionDefinitions[i]);
for (var i in vehicle_1.VehicleFunctionDefinitions)
    exports.ClientDefinitions.push(vehicle_1.VehicleFunctionDefinitions[i]);
for (var i in ped_1.PedFunctionDefinitions)
    exports.ClientDefinitions.push(ped_1.PedFunctionDefinitions[i]);
var tmpDef;
