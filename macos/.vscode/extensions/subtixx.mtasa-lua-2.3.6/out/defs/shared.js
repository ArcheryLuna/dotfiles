...
exports.SharedDefinitions = new Array();
exports.SharedModuleDefinitions = new Array();
var tmpDef = new defs_1.MTAFunction;
...
tmpModuleDef.methods.push(new defs_1.LuaMethod("remove", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("gmatch", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("match", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("next", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("escape", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("sub", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("insert", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("len", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("fold", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("gsub", "Returns a copy of the original input string with replaced matches from the pattern by the replacement value.", ["string input", "string pattern", "mixed replace", "[, int match_limit = utf8.len( input ) ]"], (_a = {}, _a["input"] = "A string character sequence", _a["pattern"] = "A string match pattern", _a["replace"] = "A string literal OR an integer value OR a function (see examples below) OR a table ({ match = replacement })", _a), ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("char", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("byte", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("charpos", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("find", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("ncasecmp", "", [], {}, ""));
tmpModuleDef.methods.push(new defs_1.LuaMethod("reverse", "", [], {}, ""));
exports.SharedModuleDefinitions.push(tmpModuleDef);
